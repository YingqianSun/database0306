...
(
  id    int auto_increment primary key comment 'id PK',
  title varchar(20)  not null comment 'activity title NN'
#   time  varchar(20)  not null comment 'activity time NN',
#   place varchar(100) not null comment 'activity place NN'
...
-- create
insert into db_a.activity(id, title) value (null, '植物园一日游');
insert into db_a.activity(id, title) value (null, '动物园一日游');
...
# truncate db_a.user;  -- id重新开始  ；事务不能rollback
